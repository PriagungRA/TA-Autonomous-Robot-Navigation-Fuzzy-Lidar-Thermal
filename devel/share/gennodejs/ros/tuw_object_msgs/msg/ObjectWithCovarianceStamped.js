...
class ObjectWithCovarianceStamped {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('object')) {
        ...
        this.object = new ObjectWithCovariance();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ObjectWithCovariance.serialize(obj.object, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObjectWithCovarianceStamped(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [object]
    data.object = ObjectWithCovariance.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ObjectWithCovariance.getMessageSize(object.object);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObjectWithCovarianceStamped(null);
    ...
    if (msg.object !== undefined) {
      resolved.object = ObjectWithCovariance.Resolve(msg.object)
    }
    else {
      resolved.object = new ObjectWithCovariance()
    }
...
module.exports = ObjectWithCovarianceStamped;
