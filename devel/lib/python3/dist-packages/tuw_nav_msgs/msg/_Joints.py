...
"""autogenerated by genpy from tuw_nav_msgs/Joints.msg. Do not edit."""
import codecs
import sys
...
class Joints(genpy.Message):
  _md5sum = "a834f7e9b152b7263c552a7c00ab3383"
  _type = "tuw_nav_msgs/Joints"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """#Message for sensing/control of a independent joints
Header header
...
string frame_id
"""
  __slots__ = ['header','name','position','velocity','torque']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,position,velocity,torque
