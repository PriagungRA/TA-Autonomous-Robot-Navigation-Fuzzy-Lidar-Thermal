...
struct Graph_
{
  ...
  _origin_type origin;
   ...
   typedef std::vector< ::tuw_multi_robot_msgs::Vertex_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::tuw_multi_robot_msgs::Vertex_<ContainerAllocator> >> _vertices_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tuw_multi_robot_msgs::Graph_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.vertices.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::tuw_multi_robot_msgs::Vertex_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.vertices[i]);
    }
    if (v.vertices.empty() || false)
      s << "]";
  }
