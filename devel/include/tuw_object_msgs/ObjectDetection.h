...
struct ObjectDetection_
{
  ...
  _type_type type;
   ...
   typedef std::vector< ::tuw_object_msgs::ObjectWithCovariance_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::tuw_object_msgs::ObjectWithCovariance_<ContainerAllocator> >> _objects_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> OBJECT_TYPE_PERSON;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> OBJECT_TYPE_OBSTACLE;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> OBJECT_TYPE_TRAFFIC_CONE;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> OBJECT_TYPE_DOOR;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> SENSOR_TYPE_GENERIC_LASER_2D;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> SENSOR_TYPE_GENERIC_LASER_3D;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> SENSOR_TYPE_GENERIC_MONOCULAR_VISION;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> SENSOR_TYPE_GENERIC_STEREO_VISION;
  static const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> SENSOR_TYPE_GENERIC_RGBD;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tuw_object_msgs::ObjectDetection_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.objects.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::tuw_object_msgs::ObjectWithCovariance_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.objects[i]);
    }
    if (v.objects.empty() || false)
      s << "]";
    if (true || !indent.empty())
