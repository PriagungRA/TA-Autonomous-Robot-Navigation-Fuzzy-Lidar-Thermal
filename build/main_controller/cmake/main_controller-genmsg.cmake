...
message(STATUS "main_controller: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imain_controller:/home/ubuntu/TA/final_ws/src/main_controller/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg" NAME_WE)
add_custom_target(_main_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "main_controller" "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg" ""
)
...
### Generating Messages
_generate_msg_cpp(main_controller
  "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_eus(main_controller
  "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/main_controller
)

### Generating Services

### Generating Module File
_generate_module_eus(main_controller
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/main_controller
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(main_controller_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(main_controller_generate_messages main_controller_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg" NAME_WE)
add_dependencies(main_controller_generate_messages_eus _main_controller_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(main_controller_geneus)
add_dependencies(main_controller_geneus main_controller_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS main_controller_generate_messages_eus)

### Section generating for lang: genlisp
### Generating Messages
_generate_msg_lisp(main_controller
  "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_nodejs(main_controller
  "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/main_controller
)

### Generating Services

### Generating Module File
_generate_module_nodejs(main_controller
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/main_controller
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(main_controller_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(main_controller_generate_messages main_controller_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg" NAME_WE)
add_dependencies(main_controller_generate_messages_nodejs _main_controller_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(main_controller_gennodejs)
add_dependencies(main_controller_gennodejs main_controller_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS main_controller_generate_messages_nodejs)

### Section generating for lang: genpy
### Generating Messages
_generate_msg_py(main_controller
  "/home/ubuntu/TA/final_ws/src/main_controller/msg/ControllerData.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/main_controller)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/main_controller
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(main_controller_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/main_controller)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/main_controller
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(main_controller_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/main_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/main_controller\")")
  # install generated code
  install(
